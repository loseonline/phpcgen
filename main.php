...
if(!isBanned($userId) && !isMuted($userId)){
  ...
  if($userId == $config['adminID']){
    ...
    bot('sendmessage',[
        'chat_id'=>$chat_id,
        'text'=>"<b>Merhaba @$username valla botun yarısı ingilizce,
...
$messagesec",
    ...
    'reply_markup'=>json_encode(['inline_keyboard' => [
        [
          ['text' => "💠 Created By 💠", 'url' => "t.me/loseonline"]
        ],
        [
          ['text' => "💎 Source Code 💎", 'url' => "t.me/loseonline"]
        ],
...
if(strpos($message, "/cmds") === 0 || strpos($message, "!cmds") === 0){
  ...
  if(!isBanned($userId) && !isMuted($userId)){
    bot('sendmessage',[
    'chat_id'=>$chat_id,
    'text'=>"<b>Hangi komutları kontrol etmek istersiniz?</b>",
    'parse_mode'=>'html',
    'reply_to_message_id'=> $message_id,
    'reply_markup'=>json_encode(['inline_keyboard'=>[
    [['text'=>"💳 CC Checker Gates",'callback_data'=>"checkergates"]],[['text'=>"🛠 Diğer Komutlar",'callback_data'=>"othercmds"]],
    ],'resize_keyboard'=>true])
    ]);
  }
...
<b>ϟ Join <a href='t.me/loseonline'>ᏞøsᎬ Øɴʟɪɴᴇ</a></b>",
    'parse_mode'=>'html',
...
<b>/me | !me</b> - Bilgileriniz
<b>/stats | !stats</b> - Checker çalıştır
<b>/key | !key</b> - SK Key Checker
<b>/bin | !bin</b> - Bin bakmak
