...
|
*/
$config['botToken'] = "5626562432:AAECNSkHFT3r_ODKCHQAfgisOLr74GNt4uo";
...
|
*/
$config['timeZone'] =  "Avrupa/İstanbul";
...
$config['db']['username'] =  "loscomtr_lose";
$config['db']['password'] =  "lose01.@";
$config['db']['database'] =  "loscomtr_lose";
